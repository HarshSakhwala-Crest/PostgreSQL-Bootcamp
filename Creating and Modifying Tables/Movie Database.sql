-- USING PGADMIN GUI : CREATE A DATABASE movies
...
-- CREATING JUNCTION TABLE movies_actors WITH movies AND actors TABLES
...
-- INSERTING DATA IN movies_actors TABLE
...
-- INSERTING DATA IN movies_revenues TABLE
